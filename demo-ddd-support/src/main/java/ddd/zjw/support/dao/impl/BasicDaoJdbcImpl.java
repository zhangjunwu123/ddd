...
import ddd.zjw.support.dao.impl.mybatis.GenericDao;
...
public class BasicDaoJdbcImpl implements BasicDao {
	...
	public <T> void insert(T entity) {
		...
		try {
			...
			throw new RuntimeException("error when insert entity", e);
		}
	}
	...
	public <T> void update(T entity) {
		...
		try {
			...
			throw new RuntimeException("error when update entity", e);
		}
	}
	...
	public <T> void insertOrUpdate(T entity) {
		...
		try {
			...
			if(e.getCause() instanceof SQLIntegrityConstraintViolationException)
				update(entity);
			else throw new RuntimeException("error when insert entity", e);
		}
	}
	...
	public <S extends Serializable, T extends Entity<S>> T load(S id, T template) {
		if(id==null||template==null) throw new RuntimeException("illegal parameters!");
		template.setId(id);
