...
public class BeanUtils {
	...
	public static Object getValueByField(Object bean, String fieldName) {
		...
		try {
			...
			throw new RuntimeException("error when get value from the bean[bean:"+bean+",field:"+fieldName+"]", e);
		}
	}
	...
	public static void setValueByField(Object bean, String fieldName, Object value) {
		try {
			...
			throw new RuntimeException("error when set the value to the bean", e);
		}
	}
	...
	public static Method getMethodIfExists(Object service, String methodName) {
		if(methodName==null||methodName.isEmpty()) throw new RuntimeException("The method name is empty!");
	...
	public static Method getMethod(Object service, String methodName) {
		...
		throw new RuntimeException("No such method["+methodName+"] in the Object["+service.getClass().getName()+"]");
	}
}
